...
public class StuffManagement extends JFrame implements ActionListener
{
	ImageIcon img,icon;
	JLabel titleLabel,titleLabel1,fnLabel,lnLabel,phnLabel,nidLabel,wpLabel,sLabel,imgLabel;
	JTextField fnTf,lnTf,phnTf,nidTf,wpTf, sTf;
	...
	FrameTwo ft;
	Cursor cursor;
	String[] columns = {"First name","Last name","Phone Number","NID Number","Working Post","Selary"};
	String[] rows = new String[10];
	

public StuffManagement()
	{
		super("Friends Hostel-Stuff Management");
		...
		titleLabel = new JLabel("Stuff Form");
		titleLabel.setBounds(300,6,250,50);
		titleLabel.setFont(myFont);
		panel.add(titleLabel);

		titleLabel1 = new JLabel("Stuff Details");
		...
		nidLabel.setBounds(40,200,100,30);
		nidLabel.setFont(myFont1);
		panel.add(nidLabel);

		wpLabel= new JLabel("Working Post :");
		wpLabel.setBounds(430,50,130,30);
		wpLabel.setFont(myFont1);
		panel.add(wpLabel);

		sLabel = new JLabel("Selary :");
		sLabel.setBounds(430,100,100,30);
		sLabel.setFont(myFont1);
		panel.add(sLabel);
		...
		nidTf.setBounds(170,200,120,30);
		nidTf.setFont(myFont1);
		panel.add(nidTf);

		wpTf= new JTextField();
		wpTf.setBounds(580,52,120,30);
		wpTf.setFont(myFont);
		panel.add(wpTf);

		sTf= new JTextField();
		sTf.setBounds(580,102,120,30);
		sTf.setFont(myFont);
		panel.add(sTf);
        ...
        scroll.setBounds(10,300,740,265);		
        panel.add(scroll);
		...
		table.addMouseListener(new MouseAdapter()
		{
			...
			{   
				...
				String nid_no = model.getValueAt(numOfRow,3).toString();
				String wp_name= model.getValueAt(numOfRow,4).toString();
				String selary = model.getValueAt(numOfRow,5).toString();
				
				fnTf.setText(f_name );
			    lnTf.setText(l_name);
			    phnTf.setText(phn_no);
				nidTf.setText(nid_no);
				wpTf.setText(wp_name);
				sTf.setText(selary);
		...
		img= new ImageIcon(getClass().getResource("/images/stm.jpg"));
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if (ae.getSource()==deleteBtn)
		{
		  ...
		  String nid_no = nidTf.getText();
		  String wp_name= wpTf.getText();
		  String selary = sTf.getText();
		  
		  model.setValueAt(f_name,numOfRow,0);
		  model.setValueAt(l_name,numOfRow,1);
	      model.setValueAt(phn_no,numOfRow,2);
	      model.setValueAt(nid_no,numOfRow,3);
	      model.setValueAt(wp_name,numOfRow,4);
	      model.setValueAt(selary,numOfRow,5);
		}
